...
exports.TestDataHelper = exports.testStudentGroups = exports.testCourses = exports.testLecturers = exports.testVenues = exports.testUsers = void 0;
exports.testUsers = [
    {
...
class TestDataHelper {
    ...
    async loginAs(userType) {
        const user = exports.testUsers.find(u => u.role === userType);
        if (!user)
            throw new Error(`No test user found for role: ${userType}`);
